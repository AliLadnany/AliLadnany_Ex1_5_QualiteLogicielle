...
import bankAccountApp.helpers.SaveManager;
...
public class BankAccountApp {
	...
	public static void main(String[] args) {
		...
		Bank accManager;
		// TODO: The following should be in the environment variable referenced in SaveManager.env_var
		...
		accManager = saveManager.loadAccounts();
		...
		scan.close();
		saveManager.saveAccounts(accManager);
		System.out.println("End of program... Press any key to quit.");
		if (scan != null)
			scan.close();
	}
}
